...
func createContracts(client aggkittypes.EthClienter, globalExitRoot, rollupManager common.Address) (
...
func buildAppender(client aggkittypes.EthClienter, globalExitRoot,
